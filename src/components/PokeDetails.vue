  ...
  <!-- PokemonDétails -->
    ...
    >
      ...
      <header class="bg-gray-200 flex items-center justify-between p-3">
        <RouterLink
          class="text-gray-600 text-3xl cursor-pointer hover:bg-transparent"
          to="/"
          >←</RouterLink
        >
      ...
      <div class="flex justify-center mb-4">
        <img
          v-for="(type, index) in typesSprites"
          :src="type"
          :alt="pokemon.types[index].type.name"
          class="w-14 h-6 mx-4"
        />
      </div>
      <!-- Les infos -->
      <div class="flex justify-around bg-gray-100 border-t border-b py-4">
        ...
        <div class="flex flex-col w-1/3 justify-around">
          <span
            v-for="abilitie in pokemon.abilities"
      ...
      <div class="p-4">
        <div v-for="stat in pokemon.stats" class="flex items-center mb-2">
          ...
          <div
            class="flex-auto h-2 bg-gray-200 rounded-lg overflow-hidden mx-2"
          >
            <div
              class="h-full"
              :style="{
